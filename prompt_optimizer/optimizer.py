    ...
    def optimize(self, prompt_text: str) -> str:
        ...
        examples = [
            ...
            dspy.Example(
                ...
                analysis=(
                    "This prompt lacks specificity about the type of website, the "
                    "user's skill level, or what technologies they're "
                    "interested in using."
                ),
                improved_prompt=(
                    "I'm a beginner with basic HTML/CSS knowledge looking to create "
                    "a personal portfolio website. Please provide a step-by-step "
                    "guide on how to build a responsive portfolio site, "
                    "including recommended frameworks, hosting options, and "
                    "essential features for showcasing my work effectively."
                ),
            ),
        ]
        ...
        return (
            ...
            if result
            else "Failed to optimize prompt using example-based approach"
        )
