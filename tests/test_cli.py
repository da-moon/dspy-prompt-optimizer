...
def test_cli_missing_api_key() -> None:
    ...
    with runner.isolated_filesystem():
        ...
        result = runner.invoke(
            main, ["self", "test_prompt.txt"], env={"ANTHROPIC_API_KEY": ""}
        )
...
def test_example_oneshot_mode(mock_dspy_for_cli: None) -> None:
    ...
    with runner.isolated_filesystem():
        ...
        result = runner.invoke(
            main, ["example", "test_prompt.txt", "--api-key", "test-key", "--verbose"]
        )
...
def test_example_command_missing_api_key() -> None:
    ...
    with runner.isolated_filesystem():
        ...
        result = runner.invoke(
            main, ["example", "test_prompt.txt"], env={"ANTHROPIC_API_KEY": ""}
        )
...
def test_generate_examples_missing_api_key() -> None:
    ...
    with runner.isolated_filesystem():
        result = runner.invoke(
            main, ["generate-examples", "examples.json"], env={"ANTHROPIC_API_KEY": ""}
        )
